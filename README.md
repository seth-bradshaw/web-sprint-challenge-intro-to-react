...
React is a library of JS that makes it easier to minipulate the virtual DOM with UI.
1. Describe component state.
When the component is rendered, the variable with initialize with the set value(or state).
1. Describe props.
When you want to pass either variables or some type of data to another file, in which you can minipulate the data, you would do so by passing props.
1. What are side effects, and how do you sync effects in a React component to changes of certain state or props?
Side Effects are effects that take place with UI. For instance if the user clicks a details button then it will display the details. 
